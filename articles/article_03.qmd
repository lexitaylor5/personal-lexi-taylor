...
<blockquote>
The major enhancement I made was to the navbar on my website. I was able to change the background color, the style of the text, the color of the font when hovering over the headers on my navbar, and made a dropdown menu for `articles` and `blog`. The image below shows the enhancement to my navbar. 
