...
I added the `text` as Articles and Blog to the `menu` in my code to start the process of the dropdown. I then added the link and text to both the Articles and Blog headers. By doing this, each header has a drop down that has the title of each article and blog that you can click on. 
