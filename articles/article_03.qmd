...
## Navbar Hover Color
<blockquote>
I was able to add the color oranage when hovering over the words on the navbar by adding the code below in my `style.css` folder. I reffered to the website as well as the Github page from Quarto below when trying to learn how to add a hover color:
```{=html}
<button type="button" class="btn btn-primary">
