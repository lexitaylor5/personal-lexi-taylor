...
<blockquote>
The major enhancement I made was to the navbar on my website. I was able to change the background color, the font style of the text, the color of the font when hovering over  `home `,  `about`, `articles`, and `blog` and made a dropdown menu for `articles` and `blog`. The image below shows the enhancement to my navbar. 
...
<blockquote>
The way I was able to chnage the background color and the font of my navbar will be demonstrated in the code below. 
...
## Navbar Hover Color
<blockquote>
I was able to add the color oranage color when hovering over the words on the navbar by adding the code below in my `style.css` folder.
